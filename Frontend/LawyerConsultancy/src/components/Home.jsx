...
const Home = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const query = `/lawyers?law=${form1.law.value}&lang=${form1.lang.value}`;
    navigate(query);
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="group bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 relative overflow-hidden">
              ...
              <div className="relative">
                ...
                <a href="/chat" className="inline-flex items-center text-blue-600 font-medium group-hover:text-blue-700">
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="relative">
            ...
            <div className="relative bg-white p-8 rounded-2xl shadow-xl border border-gray-100">
              ...
              <form name='form1' onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="group">
                  ...
                  <div className="relative">
                    <select name="law" className="block w-full px-4 py-3 rounded-xl border border-gray-200 bg-gray-50 focus:bg-white focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all duration-200 appearance-none">
                      ...
                      <option value="Intellectual Property Law">Intellectual Property (IP) Law</option>
                      ...
                      <option value="Entertainment & Media Law">Entertainment & Media Law</option>
                ...
                <div>
                  ...
                  <div className="relative">
                    <select name='lang' className="block w-full px-4 py-3 rounded-xl border border-gray-200 bg-gray-50 focus:bg-white focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all duration-200 appearance-none">
