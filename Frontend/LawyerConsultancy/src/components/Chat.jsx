        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6 bg-gray-50">
          ...
          <div className="flex items-start space-x-4">
            ...
            <div className="bg-white rounded-lg p-4 shadow-sm max-w-2xl">
              <p className="text-gray-800">Hello! I'm your AI legal assistant. How can I help you today with your legal questions?</p>
            </div>
          </div>
          ...
          <div className="flex items-start space-x-4 justify-end">
            <div className="bg-blue-600 rounded-lg p-4 shadow-sm max-w-2xl">
              <p className="text-white">I need help understanding property law regulations in California.</p>
            </div>
